...
('P001', N'Bí Ẩn Dưới Đại Dương', 'Nguyễn Hữu Tài', 120, '2025-01-10', '2025-02-20', 'Việt Nam', 'Phiêu lưu', 'Một nhóm thợ lặn phát hiện bí mật cổ xưa trong lòng biển.'),
...
('SC007', 'P007', 'PH001', '2025-11-13', '09:00:00', '2D', 1),
('SC008', 'P008', 'PH002', '2025-11-13', '11:45:00', '3D', 0),
('SC009', 'P009', 'PH003', '2025-11-13', '14:30:00', 'IMAX', 1),
('SC010', 'P010', 'PH001', '2025-11-14', '17:00:00', '2D', 0),
('SC011', 'P011', 'PH002', '2025-11-14', '19:30:00', '3D', 1),
('SC012', 'P012', 'PH003', '2025-11-14', '21:45:00', 'IMAX', 0),
('SC013', 'P001', 'PH001', '2025-11-15', '09:15:00', '2D', 1),
('SC014', 'P002', 'PH002', '2025-11-15', '12:00:00', '3D', 0),
('SC015', 'P003', 'PH003', '2025-11-15', '15:00:00', 'IMAX', 1),
('SC016', 'P004', 'PH001', '2025-11-16', '17:45:00', '2D', 1),
('SC017', 'P005', 'PH002', '2025-11-16', '20:00:00', '3D', 0),
('SC018', 'P006', 'PH003', '2025-11-16', '22:30:00', 'IMAX', 1),
('SC019', 'P007', 'PH001', '2025-11-17', '10:00:00', '2D', 0),
('SC020', 'P008', 'PH002', '2025-11-17', '13:00:00', '3D', 1),
('SC021', 'P009', 'PH003', '2025-11-18', '09:00:00', '2D', 1),
('SC022', 'P010', 'PH001', '2025-11-18', '11:30:00', '3D', 0),
('SC023', 'P011', 'PH002', '2025-11-18', '14:15:00', 'IMAX', 1),
('SC024', 'P012', 'PH003', '2025-11-18', '16:45:00', '2D', 0),
('SC025', 'P001', 'PH001', '2025-11-19', '09:00:00', '3D', 1),
('SC026', 'P002', 'PH002', '2025-11-19', '11:15:00', '2D', 0),
('SC027', 'P003', 'PH003', '2025-11-19', '13:45:00', 'IMAX', 1),
('SC028', 'P004', 'PH001', '2025-11-19', '16:15:00', '2D', 0),
('SC029', 'P005', 'PH002', '2025-11-20', '09:30:00', '3D', 1),
('SC030', 'P006', 'PH003', '2025-11-20', '12:00:00', '2D', 1),
('SC031', 'P007', 'PH001', '2025-11-20', '14:30:00', 'IMAX', 0),
('SC032', 'P008', 'PH002', '2025-11-20', '17:00:00', '2D', 1),
('SC033', 'P009', 'PH003', '2025-11-21', '09:00:00', '3D', 0),
('SC034', 'P010', 'PH001', '2025-11-21', '11:30:00', '2D', 1),
('SC035', 'P011', 'PH002', '2025-11-21', '14:00:00', 'IMAX', 0),
('SC036', 'P012', 'PH003', '2025-11-21', '16:45:00', '2D', 1),
('SC037', 'P001', 'PH001', '2025-11-22', '09:15:00', '3D', 1),
('SC038', 'P002', 'PH002', '2025-11-22', '11:45:00', '2D', 0),
('SC039', 'P003', 'PH003', '2025-11-22', '14:30:00', 'IMAX', 1),
('SC040', 'P004', 'PH001', '2025-11-22', '17:00:00', '2D', 1);
...
--IF OBJECT_ID('HoaDon_KhachHang', 'U') IS NOT NULL
--    DROP TABLE HoaDon_KhachHang;

-- Tạo lại bảng mới từ kết quả truy vấn
SELECT 
    hd.MaHoaDon,
    hd.NgayLapHoaDon,
    hd.MaNhanVien,
    ...
    kh.DiaChi,
    hd.TongTien
INTO HoaDon_KhachHang
FROM HoaDon hd
JOIN KhachHang kh ON hd.MaKhachHang = kh.MaKhachHang;

SELECT * FROM HoaDon_KhachHang;
